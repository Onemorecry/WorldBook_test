...
class Book(models.Model):
    ...
    summary = models.TextField(max_length=1000, help_text='Введите красткое описание книги',
...
class Status(models.Model):
    name = models.CharField(max_length=20, help_text='Введите статус экземпляра книги', verbose_name="Статус книги")
...
class Bookinstance(models.Model):
    ...
    imprint = models.CharField(max_length=200, null=True, help_text='Введите издательство и год выпуска',
